<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(!$isAttendanceTakerOnly)
                        @can('view grades')
                            <x-nav-link :href="route('grades.index')" :active="request()->routeIs('grades.*') || request()->routeIs('subjects.*')">
                                {{ __('Grades') }}
                            </x-nav-link>
                        @endcan
                        @can('viewReports', App\Models\Attendance::class)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(!$isAttendanceTakerOnly)
                @can('view grades')
                    <x-responsive-nav-link :href="route('grades.index')" :active="request()->routeIs('grades.*') || request()->routeIs('subjects.*')">
                        {{ __('Grades') }}
                    </x-responsive-nav-link>
                @endcan
                @can('viewReports', App\Models\Attendance::class)
